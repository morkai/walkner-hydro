(function(exports){
  ...
  cubism.context = function() {
    ...
    var context_id = ++cubism_id;

    context.remove = function()
    {
      context.stop();
      d3.select(window).on('keydown.context-' + context_id, null);
    };

    d3.select(window).on("keydown.context-" + context_id, function() {
...
// Wraps the specified request implementation, and shifts time by the given offset.
    ...
    function horizon(selection) {
      ...
      selection.each(function(d, i) {
        ...
        function focus(i) {
          ...
          span.datum(value).text(isNaN(value) || value === null ? null : format);
        }
  ...
  cubism_contextPrototype.cubismRule = function() {
    var context = this,
      metric = cubism_identity;
